...
|---|---|---|---|---|---|---|---|---|
| **opencode live opencode-x-preview-f-free think-OFF** | **66.3** | 100.0 % | 66.3 % | 9.2 | 5.9 | 100.0 % | 0 | 452 s |
...
- Tasks use **9.2 tool calls against a par of 5.9**. In a live setup, verbose skills or an over-eager MCP server can push the agent into exploratory calls; trimming instructions usually recovers most of the gap.
...
- `opencode-live-opencode-x-preview-f-free-think-off.2.json` — opencode live opencode-x-preview-f-free think-OFF
## Run context

_Collected at 2026-08-25 17:56 UTC — the conditions this result must be read against._
...
_74 tool calls, classified. Built-ins identified from the static table for `opencode`; unrecognised names are reported as unattributed, not as skills._
