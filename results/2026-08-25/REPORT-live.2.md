...
|---|---|---|---|---|---|---|---|---|
| **opencode live opencode-x-preview-f-free think-OFF** | **66.7** | 100.0 % | 66.7 % | 9.4 | 5.9 | 100.0 % | 0 | 689 s |
...
- Tasks use **9.4 tool calls against a par of 5.9**. In a live setup, verbose skills or an over-eager MCP server can push the agent into exploratory calls; trimming instructions usually recovers most of the gap.
...
- `opencode-live-opencode-x-preview-f-free-think-off.json` — opencode live opencode-x-preview-f-free think-OFF
## Run context
